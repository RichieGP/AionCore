...
Wave 3/4/5 共 **70 个新模块全部 ≤ 120 行**；超 100 行的模块（W3-D15b / W3-D16b(80) / W4-D18b-2(90) / W4-D20b-2(60) / W4-D22 / W5-D26b-1(70) / W5-D26b-2(70) / W5-D29b(100)）都在 modules.md 对应条目给出"不能再拆理由"。
...
| Wave 5（闭环补全） | Guide MCP / spawn / shutdown / 10-phase 事件 | 32 | 6 天 | 12.7 人天 |
| **合计** | — | **88 人模块** | **~18 日历日** | **~51 人天** |

**建议工期**：6 周（Wave 1+2 = 2 周，Wave 3 = 0.5 周，Wave 4 = 1 周，Wave 5 = 1.5 周，buffer 1 周覆盖 D7a/b/c 同文件串行 + 真 CLI 跑不起来降级）。

> Wave 5 模块数从 19 → 32，因为：D26b 拆 2、D29a 拆 4、D29c 拆 2、D29d 拆 3、D30a 拆 2、D30d 拆 3、D31b 拆 3（共 +13；另 W5-D27/28/29b/30c 保持不动）。
